...
Thanks for your interest in contributing! Luna Agent is a small, focused project and we want to keep it that way.

## Development Setup

```bash
git clone https://github.com/nonatofabio/luna-agent.git
cd luna-agent
python3 -m venv .venv
...
Use [GitHub Issues](https://github.com/nonatofabio/luna-agent/issues) with the bug report template.
